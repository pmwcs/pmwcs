...
describe('Checkbox', () => {
  ...
  test('can be checked', () => {
    const checkbox = mount(<Checkbox checked onChange={() => {}} />)
    expect(
      (checkbox.find('input').getDOMNode()).checked
    ).toEqual(true)
  })
  ...
  test('can be disabled', () => {
    ...
    expect(
      (checkbox.find('input').getDOMNode()).disabled
    ).toEqual(true)
  })
  ...
  test('can be indeterminate', () => {
    ...
    expect(
      (checkbox.find('input').getDOMNode()).indeterminate
    ).toEqual(true)
  })
