...
describe('DataTable', () => {
  ...
  it('can have stickyRows', () => {
    ...
    expect(el.html().includes('pmwc-data-table--sticky-rows')).toBe(true)
  })
  ...
  it('can have stickyColumns', () => {
    ...
    expect(el.html().includes('pmwc-data-table--sticky-columns')).toBe(true)
  })
  ...
  it('can have have activated row', () => {
    ...
    expect(el.html().includes('pmwc-data-table__row--activated')).toBe(true)
  })
  ...
  it('can have have aligned cells', () => {
    ...
    expect(el.html().includes('pmwc-data-table__cell--align-start')).toBe(true)
    expect(el.html().includes('pmwc-data-table__cell--align-middle')).toBe(
      true
    )
    expect(el.html().includes('pmwc-data-table__cell--align-end')).toBe(true)
  })
  ...
  it('can have have sorted columns', () => {
    ...
    const clickCell = (el) => {
      const cell = el.find('.pmwc-data-table__head-cell--sortable').first()
      // cell.simulate('click')
      cell.props().onClick()
    }

    let el = getComp()
    expect(el.html().includes('pmwc-data-table__head-cell--sortable')).toBe(
      true
    )
    ...
    el = getComp()
    expect(
      el.html().includes('pmwc-data-table__head-cell--sorted-ascending')
    ).toBe(true)
    ...
    expect(
      el.html().includes('pmwc-data-table__head-cell--sorted-descending')
    ).toBe(true)
