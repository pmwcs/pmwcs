...
describe('Icon', () => {
  it('renders ligature', () => {
    ...
    expect(el.html()).toBe(
      '<i class="pmwc-icon pmwc-icon--ligature material-icons">favorite</i>'
    )
  })
  ...
  it('renders Url', () => {
    ...
    expect(el2.html()).toBe(
      '<i class="pmwc-icon pmwc-icon--url material-icons" style="background-image: url(images/icons/twitter.png);"></i>'
    )
  })
  ...
  it('renders with JSX', () => {
    ...
    expect(el.html()).toBe(
      '<i class="pmwc-icon pmwc-icon--component material-icons"><div style="background: purple; width: 24px; height: 24px;"></div></i>'
    )
  ...
  it('can be sizes', () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(el.html().includes(`pmwc-icon--size-${size}`)).toEqual(true)
    })
  })
  ...
  it('renders className', () => {
    ...
    expect(el.html()).toBe(
      '<i class="pmwc-icon pmwc-icon--className icon ion-ionic"></i>'
    )
  })
