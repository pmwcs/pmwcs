...
import { TopAppBar, TopAppBarRow, TopAppBarSection, TopAppBarTitle, TopAppBarNavigationIcon, TopAppBarActionItem, TopAppBarFixedAdjust } from '@pmwc/top-app-bar'
import { Icon } from '@pmwc/icon'
import { ThemeProvider } from '@pmwc/theme'
import { Typography } from '@pmwc/typography'
import { Ripple } from '@pmwc/ripple'
import { Drawer, DrawerContent, DrawerAppContent } from '@pmwc/drawer'
import { ListItem, CollapsibleList, SimpleListItem, List } from '@pmwc/list'
import { SimpleMenu, MenuItem } from '@pmwc/menu'
...
var MainMenuItem = function (_a) {
  var url = _a.url; var label = _a.label
...
var GithubSvg = function () {
  return (React.createElement('svg', { viewBox: '0 0 24 24', width: '24', height: '24' },
...
function AppBar (_a) {
  var onNavClick = _a.onNavClick; var children = _a.children
    ...
    React.createElement(TopAppBar, { fixed: true, className: 'app__top-app-bar' },
      React.createElement(TopAppBarRow, null,
        React.createElement(TopAppBarSection, { alignStart: true },
          ...
          React.createElement(TopAppBarTitle, { tag: Link, to: '/' }, 'PMWC'),
          React.createElement(SimpleMenu, {
            handle: React.createElement('span', { className: 'app__version' },
        ...
        React.createElement(TopAppBarSection, { alignEnd: true },
          children,
          React.createElement(TopAppBarActionItem, { tag: 'a', href: 'https://github.com/jamesmfriedman/pmwc', icon: React.createElement(GithubSvg, null) })))),
...
function Nav (props) {
  return (React.createElement(React.Fragment, null,
    React.createElement(Drawer, __assign({ id: 'main-nav' }, props),
      ...
      React.createElement(Ripple, { tag: 'a', href: 'https://opencollective.com/pmwc', className: 'made-by' },
...
export function App () {
  ...
  var _a = __read(useState(!isMobile), 2); var menuIsOpen = _a[0]; var setMenuIsOpen = _a[1]
  var _b = __read(useState('page-' + (window.location.pathname.split('/').pop() || 'home')), 2); var pageId = _b[0]; var setPageId = _b[1]
  var _c = __read(useState(window.localStorage.getItem('pmwcTheme') || 'Baseline'), 2); var theme = _c[0]; var setTheme = _c[1]
  useEffect(function () {
  ...
  return (React.createElement(ThemeProvider, { options: getTheme(theme), className: 'app__root', tag: 'div', id: pageId },
    ...
    }, !isMobile && (React.createElement(ThemePicker, {
      selectedThemeName: theme,
      onThemeClick: function (themeName) {
        window.localStorage.setItem('pmwcTheme', themeName)
        setTheme(themeName)
      }
    }))),
...
function NavItems (_a) {
  ...
  return (React.createElement(React.Fragment, null, options.map(function (m) {
    var _a
    if (m.options) {
      return (React.createElement(CollapsibleList, {
        key: m.label,
        defaultOpen: m.label === 'Components' || ((_a = m.options) === null || _a === void 0 ? void 0 : _a.some(function (o) {
          var _a
          return o.url &&
...
function DocRoutes (_a) {
  ...
  return (React.createElement(React.Fragment, null, options.map(function (m, index) {
    ...
    return (React.createElement(Route, {
      ...
      key: index,
      render: function () {
        document.title = 'PMWC | React Material Web Components | ' + m.label
