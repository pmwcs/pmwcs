...
var ThemePicker = /** @class */ (function (_super) {
  ...
  ThemePicker.prototype.render = function () {
    var _this = this
    var _a = this.props; var selectedThemeName = _a.selectedThemeName; var onThemeClick = _a.onThemeClick
    ...
    return (React.createElement(MenuSurfaceAnchor, null,
      ...
      React.createElement(TabBar, {
        onClick: function (evt) { return _this.setState({ open: true }) },
      ...
      React.createElement(ListItem, {
        ...
        ' ',
        React.createElement('span', { className: 'token string' }, "'pmwc/Theme';"),
        React.createElement('br', null),
        React.createElement('br', null),
        ...
        Object.entries(selectedTheme).map(function (_a, index, arr) {
          var _b = __read(_a, 2); var t = _b[0]; var val = _b[1]
...
var ColorBlock = function (_a) {
  var color = _a.color; var _b = _a.size; var size = _b === void 0 ? 1.5 : _b
  return (React.createElement('div', {
    style: {
