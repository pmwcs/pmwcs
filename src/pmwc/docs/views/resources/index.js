...
var RESOURCES = [
  {
    ...
    url: 'https://github.com/jamesmfriedman/pmwc',
    ...
    actions: [
      { label: 'Visit Github', url: 'https://github.com/jamesmfriedman/pmwc' }
    ]
  },
  {
    name: 'Code Sandbox',
    description: 'Play around with PMWC components in both Javascript and Typescript. Useful for kicking the tires, or reproducing issues.',
    url: 'https://codesandbox.io/s/pmwc-sandbox-o0s0d',
    ...
    actions: [
      ...
      {
        label: 'Typescript',
        url: 'https://codesandbox.io/s/pmwc-typescript-sandbox-y7516'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    url: 'https://opencollective.com/pmwc',
  ...
  {
    name: 'Share',
    description: "Don't keep letting your friends build software with bad UI libraries. Spread the word about PMWC.",
    url: 'https://twitter.com/intent/tweet?text=' + encodeURIComponent('You should definitely be using PMWC for your next project! https://pmwc.io'),
  ...
  },
  {
    ...
    url: 'https://opencollective.com/pmwc/updates',
    ...
    actions: [
      { label: 'Blog', url: 'https://opencollective.com/pmwc/updates' },
      {
        label: 'Changelog',
        url: 'https://github.com/jamesmfriedman/pmwc/blob/master/CHANGELOG.md'
      }
    ]
  },
  {
    ...
    url: 'https://github.com/jamesmfriedman/pmwc/issues/new',
  ...
  },
  {
    ...
    url: 'https://github.com/jamesmfriedman/pmwc/blob/master/CONTRIBUTING.md',
