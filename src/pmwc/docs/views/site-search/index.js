...
var searchGoogle = function (val, abortController) {
      ...
      switch (_b.label) {
        ...
        case 1:
          ...
          // shitty hack to ignore things in the index that just reference them homepage
            .filter(function (r) { return !r.snippet.startsWith('PMWC is a React wrapper') })
            .map(function (r) {
              return ({
                id: r.cacheId,
                icon: {
...
export function SiteSearch () {
  var _this = this
  var _a = __read(useState(''), 2); var searchVal = _a[0]; var _setSearchVal = _a[1]
  var _b = __read(useState(false), 2); var isSearching = _b[0]; var setIsSearching = _b[1]
  var timerIdRef = useRef()
  var abortControllerRef = useRef()
  var _c = __read(useState([]), 2); var results = _c[0]; var setResults = _c[1]
  ...
  return (React.createElement(MenuSurfaceAnchor, { className: styles.siteSearchWrapper },
    React.createElement(TextField, {
      ...
      value: searchVal,
      onChange: function (evt) { return setSearchVal(evt.currentTarget.value) },
      onFocus: function () { return setIsSearching(true) },
