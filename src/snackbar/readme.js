...
export default function () {
    return (React.createElement(Docs, { title: "Snackbars", lead: "Snackbars provide brief feedback about an operation through a message at the bottom of the screen.", module: "@pmwc/snackbar", styles: [
